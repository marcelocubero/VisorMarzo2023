...
# Prueba botón
# actionButton("reset", "Resetear selecciones")
...
# Agregar botón para resetear selecciones

actionButton(inputId = "resetear", label = "Nueva búsqueda")

# Función para resetear selecciones

resetear_selecciones <- function() {
  updateSelectInput(session, "selector_aprob", selected = "Todos")
  updateSelectInput(session, "selector_canton", selected = "Todos")
  updateSelectInput(session, "selector_distrito", selected = "Todos")
}

# Observador de eventos para el botón
...
#sidebarPanel(
  sliderInput("opacity", "Transparencia:",
